...
public class Subject_andTeac extends Fragment {
    int index;
    RecyclerView recyclerview;

    public Subject_andTeac(int index) {
        this.index = index;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_subject_and_teac, container, false);
        recyclerview = (RecyclerView) view.findViewById(R.id.Recy_Subject);
...
//        Toast.makeText(Login_complete.this, "User : "+user+"Pass : "+pass, Toast.LENGTH_SHORT).show();
        String url = "http://10.80.39.17/TSP58/nursing/index.php/amis/Mobile/Ionic/Service/showAssessTeach_android/"+index;
...
//                        Toast.makeText(getActivity(), "URL รูป : "+data1[i], Toast.LENGTH_SHORT).show();
                    ...
                    Adapt_Subject_andTeacher adapter = new Adapt_Subject_andTeacher(data,data1,data2,data3);
